@php
    $packages = [
        ...
        [
            ...
            'name' => 'Комфорт',
            'price' => '130 000 ₽',
            'price_comment' => 'базовый свет',
            'theme' => 'ruby',
            'badge' => 'Оптимально',
            'features' => [
                'Ведение свадьбы с 15 до 23 часов: welcome, церемония под ключ и банкет.',
        ...
        [
            ...
            'name' => 'VIP',
            'price' => '160 000 ₽',
            'price_comment' => 'комфорт + команда',
            'theme' => 'bronze',
            'badge' => 'Отлично',
            'features' => [
                'Ведение свадьбы с 15 до 23 часов: welcome, церемония и банкет.',
                'Диджейское сопровождение + вокал',
...
<div class="pricing">
    @foreach ($packages as $package)
        <article class="card{{ $package['theme'] ? ' card--' . $package['theme'] : '' }}">
