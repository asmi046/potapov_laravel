            ...
            <div class="preview-wrapper">
                    ...
                    <div class="preview__block-img">
                        <div class="pict_wrapper">
                            <swiper-container slides-per-view="1" loop="true" autoplay="true" delay="2500">
                                <swiper-slide>
                                    <img src="{{ asset('images/profile-photo.webp') }}"
                ...
                <div class="preview__block-card">
                    ...
                    <div class="preview__block-card__text">
                        <ul>
                            <li class="card__text-icon--one">
                                И я - профессиональный ведущий с 15 - летним опытом в организации и проведении
                                мероприятий! Мой стиль — современная классика! Избегаю банальных конкурсов и пошлых
                                шуток. Только индивидуальный подход и персонализированная программа.
                            </li>
                            <li class="card__text-icon--two">
                                Работаю в тандеме с опытным диджеем, чтобы обеспечить качественное музыкальное
                                сопровождение. Использую современные диджитал-игры и интерактивные конкурсы с кнопками
                                для викторин.
                            </li>
                            <li class="card__text-icon--three">
                                Давайте сделаем из вашего события не просто рядовое торжество, а яркое и запоминающееся
                                шоу!
                            </li>
                        </ul>
                    </div>
