...
@section('main')
    ...
    <section class="price">
        <div class="container">
            ...
            <p style="text-align: center;" class="snoska">* базовый свет — это продуманное световое решение, которое делает
                праздник более стильным и атмосферным. В комплекте 4 прибора на двух т-образных стойках + 2 стойки
                освещения напротив главной сцены.</p>
            <p style="text-align: center;" class="snoska">** базовый звук — это минимальный, но достаточный набор звукового
                оборудования, чтобы мероприятие звучало профессионально и комфортно для гостей. В комплекте 2 фирменных
                колонки мощностью по 900 вт каждая.</p>
            <p style="text-align: center;" class="snoska">*** дополнительные технические возможности, а так же спецэффекты
                обсуждается на встрече, на которой составляется отдельная смета в
